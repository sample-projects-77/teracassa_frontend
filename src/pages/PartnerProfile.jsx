        ...
        <div className="partner-profile-header">
          ...
          <div className="partner-profile-info">
            <div className="partner-profile-name-row">
              ...
              {partner.isVerified && (
                <span className="verified-pill" title={t('common.verified')}>
                  <svg className="verified-pill-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="verified-pill-text">{t('common.verified')}</span>
                </span>
              )}
            </div>
